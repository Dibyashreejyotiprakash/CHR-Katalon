...
public class ii3OrderFormItemDetails1Page {
	...
	@Keyword
	public void VerifySmallLargeMenuBookAccesoriesButon() {
		boolean statusofsmallbutton = action.IsElementDisplayed(smallprintbtn)
		Assert.assertTrue(statusofsmallbutton)

		boolean statusoflargebutton = action.IsElementDisplayed(largeformatbtn)
		Assert.assertTrue(statusoflargebutton)

		boolean statusofmenubookbutton = action.IsElementDisplayed(menubook)
		Assert.assertTrue(statusofmenubookbutton)

		boolean statusofaccesoriesbutton = action.IsElementDisplayed(accesories)
		Assert.assertTrue(statusofaccesoriesbutton)
	}
