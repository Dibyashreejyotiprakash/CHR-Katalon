 ...
 class ShoppingCartPage {
	...
	Interaction action = new Interaction();
	 ...
	 By btnContinueToCheckout =By.xpath("//input[@id='ctl00_Body_sideContToCheckOutBtn']")
	  ...
	  //verify clear shopping cart

	  public boolean VerifyClearShoppingCart()
	  {
		  try
		  {
			  boolean IsShoppingCartEmpty = false;
			  String ExpectedConfirmationMsg = "YOUR SHOPPING CART IS EMPTY";
			  String ActualConfirmationMsg = Driver.FindElement(lblClearCartConfirmationMsg).Text.ToString();
			  if (ActualConfirmationMsg.ToString().ToUpper().Equals(ExpectedConfirmationMsg))
			  {
				  println(ActualConfirmationMsg);
				  return IsShoppingCartEmpty = true;
			  }
		  ...
		  {
			  println("VerifyClearShoppingCary method failed due to :"+ e);
			  throw e;
		  }
	  }
