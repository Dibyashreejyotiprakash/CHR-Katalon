...
WebUI.click(findTestObject('II-WSWADMIN/GlobalMetaTagging/Elipssys'))

WebUI.waitForElementPresent(findTestObject('II-WSWADMIN/GlobalMetaTagging/RenameOption'), 10)

WebUI.waitForElementPresent(findTestObject('II-WSWADMIN/GlobalMetaTagging/DeleteOption'), 10)
