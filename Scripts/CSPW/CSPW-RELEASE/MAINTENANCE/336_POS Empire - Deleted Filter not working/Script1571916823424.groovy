...
CustomKeywords.'com.poswm.WarehouseItemInventory.ClickOnFirstItemName'()
 ...
 String itemName = CustomKeywords.'com.poswm.WarehouseItemInventory.DeleteFirstItem'()
 println "***********" + itemName
 ...
 CustomKeywords.'com.poswm.WarehouseItemInventory.OtherFilterDeleteOption'()
 
 CustomKeywords.'com.poswm.WarehouseItemInventory.VerifyDeletedItem'(itemName)
