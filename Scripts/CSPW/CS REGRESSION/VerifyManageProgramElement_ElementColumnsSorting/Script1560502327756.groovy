...
CustomKeywords.'com.utilities.Interactions.GetUrl'(GlobalVariable.bunameapprovalsconsolidator, GlobalVariable.testtype, GlobalVariable.environment)
...
WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColHeaderElement'))

WebUI.waitForPageLoad(300)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColHeaderPrice'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForPageLoad(300, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColHeaderQtyPerPack'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForPageLoad(30, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColHeaderEstVer'))

WebUI.waitForPageLoad(30)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColHeaderEstQty'))
