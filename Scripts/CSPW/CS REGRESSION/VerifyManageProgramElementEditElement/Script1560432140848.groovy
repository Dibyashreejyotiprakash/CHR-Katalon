...
WebUI.clearText(findTestObject('CONSOLIDATOR/ManageProgramElementPage/txbQtyperpack'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('CONSOLIDATOR/ManageProgramElementPage/txbQtyperpack'), '2')

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageProgramElementPage/SaveButton'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/SaveButton'))
