...
WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColProgram'))

WebUI.delay(5)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColStartDate'))

WebUI.delay(5)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColEndDate'))

WebUI.delay(5)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/ColStatus'))
