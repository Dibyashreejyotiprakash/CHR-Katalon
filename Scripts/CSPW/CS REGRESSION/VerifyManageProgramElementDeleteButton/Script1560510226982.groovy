...
WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DeleteElementLink'))

WebUI.verifyElementNotClickable(findTestObject('CONSOLIDATOR/ManageProgramElementPage/PopUpDeleteBtn'))
