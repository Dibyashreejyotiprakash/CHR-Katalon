...
WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/txbPrice'))

WebUI.clearText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbPrice'))

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbPrice'), '123')

WebUI.clearText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbQtyPerPack'))

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbQtyPerPack'), '30')

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/btnSaveChanges'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/btnSaveChanges'))
