...
WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DeleteProgramElementCrossButton'), 0)

WebUI.verifyElementClickable(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DeleteProgramElementCrossButton'))

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DeleteProgramElementCrossButton'))
