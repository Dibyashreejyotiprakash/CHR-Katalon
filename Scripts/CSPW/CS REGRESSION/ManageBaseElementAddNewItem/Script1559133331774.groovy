...
WebUI.waitForElementClickable(findTestObject('CONSOLIDATOR/ManageElementsPage/BacktoAllElement'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/SearchForAnElementToAddToConsolidatorTextBox'))

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/SearchForAnElementToAddToConsolidatorTextBox'), 'a')

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/SearchElementFirstValue'))

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbPrice'), '5')

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/txbQtyPerPack'), '5')

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/btnAddtoProgram'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/btnAddtoProgram'))
