...
WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/lnkDeleteElement'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/lnkDeleteElement'))

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/chbDelete'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/chbDelete'))

WebUI.waitForElementClickable(findTestObject('CONSOLIDATOR/ManageElementsPage/btnDelete'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/btnDelete'))
