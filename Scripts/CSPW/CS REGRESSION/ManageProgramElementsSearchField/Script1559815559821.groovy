...
WebUI.verifyElementPresent(findTestObject('CONSOLIDATOR/ManageProgramElementPage/txbSearchForProgram'), 0)

WebUI.verifyElementClickable(findTestObject('CONSOLIDATOR/ManageProgramElementPage/txbSearchForProgram'), FailureHandling.STOP_ON_FAILURE)
