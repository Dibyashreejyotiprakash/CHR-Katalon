...
WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/FirstProgramSelectCheckBox'))

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DownloadSelectedLink'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageProgramElementPage/DownloadSelectedLink'))
