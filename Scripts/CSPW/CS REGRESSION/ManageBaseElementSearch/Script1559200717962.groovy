...
WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/SearchByElement'))

WebUI.setText(findTestObject('CONSOLIDATOR/ManageElementsPage/SearchByElement'), 'Test Item')
