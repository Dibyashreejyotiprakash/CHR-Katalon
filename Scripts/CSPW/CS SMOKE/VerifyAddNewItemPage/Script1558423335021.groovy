...
not_run: WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/LogInPage/Password'), 30)

WebUI.setText(findTestObject('CONSOLIDATOR/LogInPage/Password'), 'Ownlocal@1231')
