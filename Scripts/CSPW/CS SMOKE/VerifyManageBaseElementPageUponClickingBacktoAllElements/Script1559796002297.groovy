...
WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/BacktoAllElement'))

WebUI.waitForPageLoad(30)

WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/AddNewItemBtn'), 0)

WebUI.verifyElementPresent(findTestObject('CONSOLIDATOR/ManageElementsPage/MnageElementHeader'), 0)
