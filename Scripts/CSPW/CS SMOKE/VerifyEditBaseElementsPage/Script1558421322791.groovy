...
CustomKeywords.'com.utilities.DemooInteractions.GetUrl'(GlobalVariable.bunameconsolidator, GlobalVariable.testtypesmoek, GlobalVariable.environment)
...
WebUI.waitForElementVisible(findTestObject('CONSOLIDATOR/ManageElementsPage/FirstEditLink'), 0)

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/FirstEditLink'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Edit Element', false)
