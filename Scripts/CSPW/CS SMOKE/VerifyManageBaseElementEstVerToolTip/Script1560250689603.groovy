...
WebUI.verifyElementClickable(findTestObject('CONSOLIDATOR/ManageElementsPage/EstVerToolTip'))

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/EstVerToolTip'))
