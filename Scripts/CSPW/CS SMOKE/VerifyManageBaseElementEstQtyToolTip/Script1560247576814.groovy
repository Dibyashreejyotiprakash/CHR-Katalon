...
WebUI.verifyElementClickable(findTestObject('CONSOLIDATOR/ManageElementsPage/EstQtyToolTip'))

WebUI.click(findTestObject('CONSOLIDATOR/ManageElementsPage/EstQtyToolTip'))
