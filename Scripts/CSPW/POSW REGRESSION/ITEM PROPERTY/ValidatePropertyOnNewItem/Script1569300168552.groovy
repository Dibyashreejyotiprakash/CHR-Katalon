...
CustomKeywords.'com.poswm.WarehouseAdminItemProperty.CreateItemProperty'()

CustomKeywords.'com.poswm.Homepage.ClickOnNewItem'()

CustomKeywords.'com.poswm.WarehouseAdminItemProperty.ValidateItemPropertyOnNewItem'()
