...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/JOB CLOSING'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/JOB CLOSING'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/JOB CLOSING'))
