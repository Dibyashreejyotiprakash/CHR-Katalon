...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/MarketsBtn'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/MarketsBtn'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/MarketsBtn'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Market', false)

WebUI.verifyTextPresent('Manage Markets', false)
