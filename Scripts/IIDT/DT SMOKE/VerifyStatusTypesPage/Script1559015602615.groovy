...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/StatusTypesBtn'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/StatusTypesBtn'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/StatusTypesBtn'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Status', false)

WebUI.verifyElementPresent(findTestObject('DESIGNTRACKER/APPLICATIONADMINISTRATION/STATUSTYPE/SupplierStatuses'), 30)

WebUI.verifyElementPresent(findTestObject('DESIGNTRACKER/APPLICATIONADMINISTRATION/STATUSTYPE/DistributorStatusesRadioBtn'), 
    30)
