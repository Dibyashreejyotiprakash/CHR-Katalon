...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/AccountTypeBtn'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/AccountTypeBtn'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/AccountTypeBtn'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Account Types', false)

WebUI.verifyTextPresent('Show Retired', false)
