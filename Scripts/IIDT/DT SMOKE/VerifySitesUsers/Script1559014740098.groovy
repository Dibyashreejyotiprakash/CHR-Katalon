...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/SiteUsers'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/SiteUsers'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/SiteUsers'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Site User Administration', false)
