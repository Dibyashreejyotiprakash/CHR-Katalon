...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/ApplicationAdminTab'), 300)

WebUI.mouseOverOffset(findTestObject('DESIGNTRACKER/HomePage/ApplicationAdminTab'), 0, 0)

WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/JobNoteNotify'), 300)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/JobNoteNotify'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/JobNoteNotify'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Job Note Notification', false)
