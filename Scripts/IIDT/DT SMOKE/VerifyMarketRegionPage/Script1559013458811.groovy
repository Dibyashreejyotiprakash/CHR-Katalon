...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/HomePage/MarketRegionTab'), 30)

WebUI.mouseOver(findTestObject('DESIGNTRACKER/HomePage/MarketRegionTab'))

WebUI.click(findTestObject('DESIGNTRACKER/HomePage/MarketRegionTab'))

WebUI.waitForPageLoad(30)

WebUI.verifyTextPresent('Market Region', false)

WebUI.verifyTextPresent('Manage Market Regions', false)
