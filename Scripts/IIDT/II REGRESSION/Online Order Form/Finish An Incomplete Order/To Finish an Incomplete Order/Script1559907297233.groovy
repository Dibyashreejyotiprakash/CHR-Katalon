...
WebUI.waitForElementVisible(findTestObject('II-USERSITE/OrderOnlineForm/CreateANewCustomOrder/Page_Home Page/mnlnkOrderForm'), 
    30)
...
WebUI.waitForElementClickable(findTestObject('II-USERSITE/OrderOnlineForm/Landing Page/Finish An Incomplete Order'), 0)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Landing Page/Finish An Incomplete Order'))

WebUI.waitForPageLoad(0)

WebUI.scrollToElement(findTestObject('II-USERSITE/OrderOnlineForm/Finsh an Incomplete Order Page/Page 8'), 0)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Finsh an Incomplete Order Page/Page 8'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Finsh an Incomplete Order Page/Edit Button'))
