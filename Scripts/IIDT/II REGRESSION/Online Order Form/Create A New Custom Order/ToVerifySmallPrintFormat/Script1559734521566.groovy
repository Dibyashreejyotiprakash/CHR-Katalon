...
WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/AlI Items'))

WebUI.sendKeys(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/AlI Items'), 'Counter Card')

WebUI.waitForElementPresent(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/_Case Tucker'), 
    0)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/_Case Tucker'))

WebUI.waitForAlert(5)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Print Details1 Page/ddl Size'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/Size 3000 X 4500'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Print Details1 Page/ddl Paper'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/Paper 10pt Card Stock'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Print Details1 Page/ddl Color'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/Color Single-Sided Color'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Print Details1 Page/ddl Accessory'))

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Page_Order Form - Print Details 1/Accessory Wobbler wAdh'))
