...
CustomKeywords.'com.couponmaker.CreateDesignPage.ClickOnNoBtn'()

CustomKeywords.'com.couponmaker.ProductionSelectionPage.VerifyProductionSelectionPage'()

CustomKeywords.'com.couponmaker.ProductionSelectionPage.EnterValuesAndClickOnAddToCart'()

CustomKeywords.'com.couponmaker.ShoppingCartPage.VerifyShoppingCartPage'()

CustomKeywords.'com.couponmaker.ShoppingCartPage.ClickOnContinuetoCheckoutBtn'()

CustomKeywords.'com.couponmaker.CheckOutPage.VerifyCheckOutPage'()

CustomKeywords.'com.couponmaker.CheckOutPage.AddDtAccountAndClickonContinueToReview'()
