...
not_run: WebUI.waitForElementVisible(findTestObject('II-USERSITE/ProductSelectionPage/AddToKartBtn'), 300)

not_run: WebUI.click(findTestObject('II-USERSITE/ProductSelectionPage/AddToKartBtn'))
