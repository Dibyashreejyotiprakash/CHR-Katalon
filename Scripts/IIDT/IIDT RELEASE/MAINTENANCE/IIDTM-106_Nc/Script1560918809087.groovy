...
WebUI.selectOptionByLabel(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/ddlMarket'), 
    'Chicago Beverage Systems', false)
...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/txt Error Message'), 
    300)

WebUI.verifyElementVisible(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/txt Error Message'))

WebUI.scrollToElement(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Page_DT Home/Site Adminstration'), 0)
...
WebUI.verifyElementNotClickable(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/btnTransfer'))
