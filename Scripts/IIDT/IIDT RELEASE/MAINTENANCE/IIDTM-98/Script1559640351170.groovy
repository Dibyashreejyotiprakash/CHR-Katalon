...
WebUI.setText(findTestObject('DESIGNTRACKER/LoginPage/UserName'), 'Poojita.Mishra@brandmuscle.com')

WebUI.setText(findTestObject('DESIGNTRACKER/LoginPage/Password'), 'Pooji1@')
...
WebUI.waitForElementVisible(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/chkSelectJobId'), 
    30)

WebUI.click(findTestObject('DESIGNTRACKER/SalesPeopleJobViewTransfer/Sales People Jobs ViewTransfer page/chkSelectJobId'))
