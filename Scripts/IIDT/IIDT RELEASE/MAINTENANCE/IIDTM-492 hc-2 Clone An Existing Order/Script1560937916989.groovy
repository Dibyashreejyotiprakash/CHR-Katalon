...
WebUI.scrollToElement(findTestObject('II-USERSITE/OrderOnlineForm/Print Details 2 Page/label Design Description'), 0)
...
WebUI.scrollToElement(findTestObject('II-USERSITE/OrderOnlineForm/Order Summary Page/Label Product Line'), 0)

WebUI.waitForElementVisible(findTestObject('II-USERSITE/OrderOnlineForm/Order Summary Page/label Price'), 0)

WebUI.verifyElementPresent(findTestObject('II-USERSITE/OrderOnlineForm/Order Summary Page/label Price'), 0)
