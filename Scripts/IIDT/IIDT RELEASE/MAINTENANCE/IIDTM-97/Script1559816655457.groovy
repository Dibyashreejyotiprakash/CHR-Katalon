...
WebUI.waitForElementClickable(findTestObject('II-USERSITE/OrderOnlineForm/Job Search Page/txb Search By DT Number'), 0)
...
WebUI.waitForElementClickable(findTestObject('II-USERSITE/OrderOnlineForm/Search Results Page/Btn ExpandColumn'), 0)

WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/Search Results Page/Btn ExpandColumn'))

WebUI.waitForElementClickable(findTestObject('II-USERSITE/OrderOnlineForm/Search Results Page/chkbx JobLineId'), 0)
...
WebUI.waitForElementClickable(findTestObject('II-USERSITE/OrderOnlineForm/Search Results Page/btn Add Selected Item(s)'), 
    0)
