...
WebUI.verifyElementPresent(findTestObject('II-WSWADMIN/BulkMetaTaggingPage/AddToExistingRadioBtn'), 10)

WebUI.verifyElementPresent(findTestObject('II-WSWADMIN/BulkMetaTaggingPage/OverWriteExistingRadioBtn'), 10)

WebUI.verifyElementPresent(findTestObject('II-WSWADMIN/BulkMetaTaggingPage/ContinueBtn'), 10)
