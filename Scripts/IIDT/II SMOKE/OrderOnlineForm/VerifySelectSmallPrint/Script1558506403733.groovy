...
WebUI.setText(findTestObject('II-USERSITE/OrderOnlineForm/CreateANewCustomOrder/Page_OrderHeader/txbNewAccount'), 
    'test')
...
WebUI.click(findTestObject('II-USERSITE/OrderOnlineForm/CreateANewCustomOrder/Page_ItemDetails/btnSelectSmallPrint'))
